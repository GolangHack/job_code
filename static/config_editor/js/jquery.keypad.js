...
&lt;div&gt;&lt;/div&gt;</pre>
  ...
  return ch.toUpperCase();
		...
		_backValue: function(inst) {
			...
			elem.setSelectionRange(range[0]-1, range[0]-1)
			console.log("deleted", range[0])
		},
		...
		_selectValue: function(inst, value) {
			var arrResult = this.insertValue(inst._input[0], value);
			this._setValue(inst, inst._input.val());
			this._notifyKeypress(inst, value);
			arrResult[0].setSelectionRange(arrResult[1], arrResult[1]);
		},
